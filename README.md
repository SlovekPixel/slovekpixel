...
| **Стек технологий** | *JavaScript, TypeScript, Node.js, NestJS, AdonisJS, Python, Docker, Docker-compose.* |
|---------------------|----------------------------------------------------------------------------------------------------------------------|
| **DataBases** | *PostgreSQL, ManticoreSearch, Redis* | 
| **Тестирование** | *Vitest, Jest, Mocha, Chai* | 
| **Доп. навыки** | *Деплой, Nginx, BullMQ, RabbitMQ* | 
